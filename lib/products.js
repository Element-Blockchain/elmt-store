...
export const STRIPE_PRICE_IDS = {
  ...
  99: 'price_1TduHwE4dO5YNsqVdIX2nh4e', // $1 Test Product (Digital)
  100: 'price_1TeO6gE4dO5YNsqVEvHFBIr1', // $1 Test Product (Physical)
}
...
export const products = [
  ...
  {
    id: 100,
    name: '$1 Test Product (Physical)',
    category: 'swag',
    categoryLabel: 'Test',
    desc: 'Internal test product only. Do not purchase. Tests shipping address collection.',
    priceUSD: 1,
    img: null,
    icon: '📦',
    soldOut: false,
